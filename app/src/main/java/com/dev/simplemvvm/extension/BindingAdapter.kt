package com.dev.simplemvvm.extension
...
import com.dev.simplemvvm.ui.SpaceItemDecoration
import com.dev.simplemvvm.ui.detail.DetailAdapter
...
fun setItems(view: RecyclerView, items: List<CharacterModel>?) {
